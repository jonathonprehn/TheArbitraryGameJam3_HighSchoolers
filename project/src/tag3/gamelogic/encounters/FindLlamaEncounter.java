 ...
 */
public class FindLlamaEncounter implements RandomEncounter {
    ...
    public void handleEncounter(final PartyWrapper partyWrapper, final PlayState gameState) {
        gameState.askForConfirmation(new ConfirmCommand() {
            ...
            public void onYes() {
                accepted = true;
                partyWrapper.getRawParty().addLlama(amount);
            }
            ...
            public String afterChoiceText() {
                String message;
                if (accepted) {
                    message = "You have gained "+amount+" llamas";
                } else {
                    message = "You ignored the llamas";
                }
                return message;
            }
        });
